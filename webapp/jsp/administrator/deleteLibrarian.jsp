        ...
        <div class="col-xs-12 col-sm-12 col-md-10 sideColumn">
            ...
            <div class="row deleteMemberHeader" style="background-color: #8BC34A;">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 sideColumn">
                    <span><fmt:message key="deleteLibrarianInfo" bundle="${booking}"/></span>
                </div>
            </div>
            <c:if test="${ not empty librarianList}">
                <div class="row googleTableRow">
                    <table id="example" class="mdl-data-table googleTable" cellspacing="0" width="100%">
                        ...
                        <tbody>
                        <c:forEach var="librarian" items="${librarianList}" varStatus="count">
                            <tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <fmt:message key="deleteLibrarianConfirmBody" bundle="${booking}"/>
                                                </div>
